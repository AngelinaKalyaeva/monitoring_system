...
function init() {
    ...
    myMap.behaviors
        .disable(['drag', 'rightMouseButtonMagnifier','ruler','magnifier','dblClickZoom','scrollZoom']);
    ...
    cafe = ymaps.geoQuery({
        ...
        features: [{
            type: 'Feature',
            properties: {
                balloonContent: 'TOPSHMOT "Дарт Вейдер" - у нас есть печеньки!'
            },
            geometry: {
                type: 'Point',
            ...
            type: 'Feature',
            properties: {
                balloonContent: 'TOPSHMOT "Горлум" - пирожные прелесть.'
            },
            geometry: {
                type: 'Point',
            ...
            type: 'Feature',
            properties: {
                balloonContent: 'TOPSHMOT "Кирпич" - крепкий кофе для крепких парней.'
            },
            geometry: {
                type: 'Point',
